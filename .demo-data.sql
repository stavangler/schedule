...
-- trips
INSERT INTO trips ("id", "title", "description", "date") 
VALUES 
    (1, 'Amsterdam', '_descriptionAmsterdam', '2019-09-20'),
    (2, 'Gdansk', '_descriptionGdansk', '2020-04-10');

-- entries
INSERT INTO entries ("id", "date", "title", "description", "room", "starttime", "endtime", "trip_id")
VALUES 
...
-- speakers_entries
INSERT INTO speakers_entries ("speaker_id", "entry_id") 
VALUES 
    (1, 1), 
    (1, 2), 
    (2, 3),
